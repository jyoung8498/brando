        ...
        section01Fn: function(){
            ...
            var setId2 = 0;
                ...
                function mainNextSlideFn(){
                    ...
                    //다음슬라이드 예]두번째
                    slide.eq(cnt).css({zIndex:3}).animate({opacity:0},0).animate({opacity:1},1200); 
                ...
                function mainPrevSlideFn(){
                    ...
                    if(imsi!==null){ //페이지 버튼 클릭시 실행 구문
                        slide.eq(imsi).css({zIndex:3}).animate({opacity:1},0).animate({opacity:0},1200);
                    }
                    else{
                        slide.eq(cnt==n?0:cnt+1).css({zIndex:3}).animate({opacity:1},0).animate({opacity:0},1200);
                    }
